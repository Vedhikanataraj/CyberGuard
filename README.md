...
> ⚠️ **Security Notice:** CyberGuard is intended only for authorized security testing. Do not scan websites, IP addresses, hosts, or networks without explicit permission from the owner.
...
- Open port discovery
- Service detection
- Operating-system information where supported
- CPE identification
- CVE analysis
- CVSS information
